...
resource "aws_cloudwatch_log_metric_filter" "unauthorized_api_calls" {
  ...
  pattern        = var.unauthorized_api_calls_pattern == "" ? "{(($.errorCode = \"*UnauthorizedOperation\") || ($.errorCode = \"AccessDenied*\")) && (($.sourceIPAddress!=\"delivery.logs.amazonaws.com\") && ($.eventName!=\"HeadBucket\"))}" : var.unauthorized_api_calls_pattern
...
resource "aws_cloudwatch_log_metric_filter" "root_usage" {
  ...
  name           = "RootUsage"
  pattern        = var.root_usage_pattern == "" ? "{ $.userIdentity.type = \"Root\" && $.userIdentity.invokedBy NOT EXISTS && $.eventType != \"AwsServiceEvent\" }" : var.root_usage_pattern
  log_group_name = var.cloudtrail_log_group_name
...
resource "aws_cloudwatch_log_metric_filter" "iam_changes" {
  ...
  name           = "IAMChanges"
  pattern        = var.iam_changes_pattern == "" ? "{($.eventName=DeleteGroupPolicy)||($.eventName=DeleteRolePolicy)||($.eventName=DeleteUserPolicy)||($.eventName=PutGroupPolicy)||($.eventName=PutRolePolicy)||($.eventName=PutUserPolicy)||($.eventName=CreatePolicy)||($.eventName=DeletePolicy)||($.eventName=CreatePolicyVersion)||($.eventName=DeletePolicyVersion)||($.eventName=AttachRolePolicy)||($.eventName=DetachRolePolicy)||($.eventName=AttachUserPolicy)||($.eventName=DetachUserPolicy)||($.eventName=AttachGroupPolicy)||($.eventName=DetachGroupPolicy)}" : var.iam_changes_pattern
  log_group_name = var.cloudtrail_log_group_name
...
resource "aws_cloudwatch_log_metric_filter" "cloudtrail_cfg_changes" {
  ...
  pattern        = var.cloudtrail_cfg_changes_pattern == "" ? "{ ($.eventName = CreateTrail) || ($.eventName = UpdateTrail) || ($.eventName = DeleteTrail) || ($.eventName = StartLogging) || ($.eventName = StopLogging) }" : var.cloudtrail_cfg_changes_pattern
  log_group_name = var.cloudtrail_log_group_name
...
resource "aws_cloudwatch_log_metric_filter" "console_signin_failures" {
  ...
  pattern        = var.console_signin_failures_pattern == "" ? "{ ($.eventName = ConsoleLogin) && ($.errorMessage = \"Failed authentication\") }" : var.console_signin_failures_pattern
  log_group_name = var.cloudtrail_log_group_name
...
resource "aws_cloudwatch_log_metric_filter" "disable_or_delete_cmk" {
  ...
  pattern        = var.disable_or_delete_cmk_pattern == "" ? "{ ($.eventSource = kms.amazonaws.com) && (($.eventName = DisableKey) || ($.eventName = ScheduleKeyDeletion)) }" : var.disable_or_delete_cmk_pattern
  log_group_name = var.cloudtrail_log_group_name
...
resource "aws_cloudwatch_log_metric_filter" "s3_bucket_policy_changes" {
  ...
  pattern        = var.s3_bucket_policy_changes_pattern == "" ? "{ ($.eventSource = s3.amazonaws.com) && (($.eventName = PutBucketAcl) || ($.eventName = PutBucketPolicy) || ($.eventName = PutBucketCors) || ($.eventName = PutBucketLifecycle) || ($.eventName = PutBucketReplication) || ($.eventName = DeleteBucketPolicy) || ($.eventName = DeleteBucketCors) || ($.eventName = DeleteBucketLifecycle) || ($.eventName = DeleteBucketReplication)) }" : var.s3_bucket_policy_changes_pattern
  log_group_name = var.cloudtrail_log_group_name
...
resource "aws_cloudwatch_log_metric_filter" "aws_config_changes" {
  ...
  pattern        = var.aws_config_changes_pattern == "" ? "{ ($.eventSource = config.amazonaws.com) && (($.eventName=StopConfigurationRecorder)||($.eventName=DeleteDeliveryChannel)||($.eventName=PutDeliveryChannel)||($.eventName=PutConfigurationRecorder)) }" : var.aws_config_changes_pattern
  log_group_name = var.cloudtrail_log_group_name
...
resource "aws_cloudwatch_log_metric_filter" "security_group_changes" {
  ...
  pattern        = var.security_group_changes_pattern == "" ? "{ ($.eventName = AuthorizeSecurityGroupIngress) || ($.eventName = AuthorizeSecurityGroupEgress) || ($.eventName = RevokeSecurityGroupIngress) || ($.eventName = RevokeSecurityGroupEgress) || ($.eventName = CreateSecurityGroup) || ($.eventName = DeleteSecurityGroup)}" : var.security_group_changes_pattern
  log_group_name = var.cloudtrail_log_group_name
...
resource "aws_cloudwatch_log_metric_filter" "nacl_changes" {
  ...
  name           = "NACLChanges"
  pattern        = var.nacl_changes_pattern == "" ? "{ ($.eventName = CreateNetworkAcl) || ($.eventName = CreateNetworkAclEntry) || ($.eventName = DeleteNetworkAcl) || ($.eventName = DeleteNetworkAclEntry) || ($.eventName = ReplaceNetworkAclEntry) || ($.eventName = ReplaceNetworkAclAssociation) }" : var.nacl_changes_pattern
  log_group_name = var.cloudtrail_log_group_name
...
resource "aws_cloudwatch_log_metric_filter" "network_gw_changes" {
  ...
  pattern        = var.network_gw_changes_pattern == "" ? "{ ($.eventName = CreateCustomerGateway) || ($.eventName = DeleteCustomerGateway) || ($.eventName = AttachInternetGateway) || ($.eventName = CreateInternetGateway) || ($.eventName = DeleteInternetGateway) || ($.eventName = DetachInternetGateway) }" : var.network_gw_changes_pattern
  log_group_name = var.cloudtrail_log_group_name
...
resource "aws_cloudwatch_log_metric_filter" "route_table_changes" {
  ...
  pattern        = var.route_table_changes_pattern == "" ? "{ ($.eventName = CreateRoute) || ($.eventName = CreateRouteTable) || ($.eventName = ReplaceRoute) || ($.eventName = ReplaceRouteTableAssociation) || ($.eventName = DeleteRouteTable) || ($.eventName = DeleteRoute) || ($.eventName = DisassociateRouteTable) }" : var.route_table_changes_pattern
  log_group_name = var.cloudtrail_log_group_name
...
resource "aws_cloudwatch_log_metric_filter" "vpc_changes" {
  ...
  name           = "VPCChanges"
  pattern        = var.vpc_changes_pattern == "" ? "{ ($.eventName = CreateVpc) || ($.eventName = DeleteVpc) || ($.eventName = ModifyVpcAttribute) || ($.eventName = AcceptVpcPeeringConnection) || ($.eventName = CreateVpcPeeringConnection) || ($.eventName = DeleteVpcPeeringConnection) || ($.eventName = RejectVpcPeeringConnection) || ($.eventName = AttachClassicLinkVpc) || ($.eventName = DetachClassicLinkVpc) || ($.eventName = DisableVpcClassicLink) || ($.eventName = EnableVpcClassicLink) }" : var.vpc_changes_pattern
  log_group_name = var.cloudtrail_log_group_name
