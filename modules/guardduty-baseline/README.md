...
| <a name="input_s3_data_events_enabled"></a> [s3\_data\_events\_enabled](#input\_s3\_data\_events\_enabled) | Whether this module manages and enables GuardDuty S3 data event protection. Set to false when the detector feature is managed separately. | `bool` | no |
