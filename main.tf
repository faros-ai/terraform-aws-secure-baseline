...
module "alarm_baseline" {
  ...
  unauthorized_api_calls_pattern   = var.unauthorized_api_calls_pattern
  no_mfa_console_signin_enabled    = var.no_mfa_console_signin_enabled
  no_mfa_console_signin_pattern    = var.no_mfa_console_signin_pattern
  mfa_console_signin_allow_sso     = var.mfa_console_signin_allow_sso
  root_usage_enabled               = var.root_usage_enabled
  root_usage_pattern               = var.root_usage_pattern
  iam_changes_enabled              = var.iam_changes_enabled
  iam_changes_pattern              = var.iam_changes_pattern
  cloudtrail_cfg_changes_enabled   = var.cloudtrail_cfg_changes_enabled
  cloudtrail_cfg_changes_pattern   = var.cloudtrail_cfg_changes_pattern
  console_signin_failures_enabled  = var.console_signin_failures_enabled
  console_signin_failures_pattern  = var.console_signin_failures_pattern
  disable_or_delete_cmk_enabled    = var.disable_or_delete_cmk_enabled
  disable_or_delete_cmk_pattern    = var.disable_or_delete_cmk_pattern
  s3_bucket_policy_changes_enabled = var.s3_bucket_policy_changes_enabled
  s3_bucket_policy_changes_pattern = var.s3_bucket_policy_changes_pattern
  aws_config_changes_enabled       = var.aws_config_changes_enabled
  aws_config_changes_pattern       = var.aws_config_changes_pattern
  security_group_changes_enabled   = var.security_group_changes_enabled
  security_group_changes_pattern   = var.security_group_changes_pattern
  nacl_changes_enabled             = var.nacl_changes_enabled
  nacl_changes_pattern             = var.nacl_changes_pattern
  network_gw_changes_enabled       = var.network_gw_changes_enabled
  network_gw_changes_pattern       = var.network_gw_changes_pattern
  route_table_changes_enabled      = var.route_table_changes_enabled
  route_table_changes_pattern      = var.route_table_changes_pattern
  vpc_changes_enabled              = var.vpc_changes_enabled
  vpc_changes_pattern              = var.vpc_changes_pattern
  organizations_changes_enabled    = var.organizations_changes_enabled
  organizations_changes_pattern    = var.organizations_changes_pattern
