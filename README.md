...
| <a name="input_aws_config_changes_pattern"></a> [aws\_config\_changes\_pattern](#input\_aws\_config\_changes\_pattern) | Pattern for aws\_config\_changes metric filter | `string` | no |
...
| <a name="input_cloudtrail_cfg_changes_pattern"></a> [cloudtrail\_cfg\_changes\_pattern](#input\_cloudtrail\_cfg\_changes\_pattern) | Pattern for cloudtrail\_cfg\_changes metric filter | `string` | no |
...
| <a name="input_console_signin_failures_pattern"></a> [console\_signin\_failures\_pattern](#input\_console\_signin\_failures\_pattern) | Pattern for console\_signin\_failures metric filter | `string` | no |
...
| <a name="input_disable_or_delete_cmk_pattern"></a> [disable\_or\_delete\_cmk\_pattern](#input\_disable\_or\_delete\_cmk\_pattern) | Pattern for disable\_or\_delete\_cmk metric filter | `string` | no |
...
| <a name="input_guardduty_s3_data_events_enabled"></a> [guardduty\_s3\_data\_events\_enabled](#input\_guardduty\_s3\_data\_events\_enabled) | Whether this module manages and enables GuardDuty S3 data event protection. Set to false when the detector feature is managed separately. | `bool` | no |
...
| <a name="input_iam_changes_pattern"></a> [iam\_changes\_pattern](#input\_iam\_changes\_pattern) | Pattern for iam\_changes metric filter | `string` | no |
...
| <a name="input_nacl_changes_pattern"></a> [nacl\_changes\_pattern](#input\_nacl\_changes\_pattern) | Pattern for nacl\_changes metric filter | `string` | no |
...
| <a name="input_network_gw_changes_pattern"></a> [network\_gw\_changes\_pattern](#input\_network\_gw\_changes\_pattern) | Pattern for network\_gw\_changes metric filter | `string` | no |
...
| <a name="input_no_mfa_console_signin_pattern"></a> [no\_mfa\_console\_signin\_pattern](#input\_no\_mfa\_console\_signin\_pattern) | Pattern for no\_mfa\_console\_signin metric filter | `string` | no |
...
| <a name="input_organizations_changes_pattern"></a> [organizations\_changes\_pattern](#input\_organizations\_changes\_pattern) | Pattern for organizations\_changes metric filter | `string` | no |
...
| <a name="input_root_usage_pattern"></a> [root\_usage\_pattern](#input\_root\_usage\_pattern) | Pattern for root\_usage metric filter | `string` | no |
...
| <a name="input_route_table_changes_pattern"></a> [route\_table\_changes\_pattern](#input\_route\_table\_changes\_pattern) | Pattern for route\_table\_changes metric filter | `string` | no |
...
| <a name="input_s3_bucket_policy_changes_pattern"></a> [s3\_bucket\_policy\_changes\_pattern](#input\_s3\_bucket\_policy\_changes\_pattern) | Pattern for s3\_bucket\_policy\_changes metric filter | `string` | no |
...
| <a name="input_security_group_changes_pattern"></a> [security\_group\_changes\_pattern](#input\_security\_group\_changes\_pattern) | Pattern for security\_group\_changes metric filter | `string` | no |
...
| <a name="input_unauthorized_api_calls_pattern"></a> [unauthorized\_api\_calls\_pattern](#input\_unauthorized\_api\_calls\_pattern) | Pattern for unauthorized\_api\_calls metric filter | `string` | no |
...
| <a name="input_vpc_changes_pattern"></a> [vpc\_changes\_pattern](#input\_vpc\_changes\_pattern) | Pattern for vpc\_changes metric filter | `string` | no |
